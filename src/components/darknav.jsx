...
import { darklogo, close, menu } from "../assets";
        ...
        <div className="fixed md:w-[80%] xs:w-[90%] z-20">
          <div className="flex items-center justify-between w-full pt-6">
            <ul className="list-none sm:flex hidden items-center flex-1">
              <li
                className={`font-lato font-normal text-base cursor-pointer text-black mr-10`}
              >
            ...
            <div className="sm:hidden">
              ...
              >
                <ul className="list-none w-[90%] mx-auto mt-10">
                  <li
                    className={`font-lato font-normal text-base cursor-pointer text-black mb-10`}
                  >
                    <Link to="/ourstory">Our Story</Link>
                  </li>
                  <li
